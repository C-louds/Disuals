...
export default function Home() {  
  return (
   <div className="h-[calc(100vh-4rem)] w-full flex flex-col gap-2 items-center justify-center overflow-hidden">
      ...
      <h1 className="text-4xl md:text-6xl font-bold text-white drop-shadow-[0_0_45px_rgba(30,0,140,0.7)] floating-text">Welcome,</h1>
      <p className="text-gray-200 text-xl floating-text drop-shadow-[0_0_45px_rgba(30,0,140,0.7)]">the successor of star dusts!</p>
      <Link href="/journal">
      <button 
      ...
      <span className="drop-shadow-[0_0_10px_rgba(30,0,140,0.4)]">Journal</span>
      </button>
      </Link>
